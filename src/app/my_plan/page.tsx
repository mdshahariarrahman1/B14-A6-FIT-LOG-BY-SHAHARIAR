...
const MyPlanPage = () => {
  ...
  const handleRemove = (id: number) => {
    const removedItem = currentData.find((item) => item.id === id);
    ...
    toast.warn(`${removedItem?.name} Remove 🦄`, {
      position: "top-right",
      autoClose: 5000,
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2 md:flex-nowrap">
                ...
                <button
                  ...
                  className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl border border-red-500/30 bg-[#111315] text-red-500 transition-all duration-200 hover:border-red-500/60 hover:bg-red-500/10"
                >
